    ...
    public class BoidJobSystem : SystemBase
    {
        ...
        */
        ...
        protected override void OnUpdate()
        {
            ...
            var cnjHandle = Entities.ForEach((ref Boid b) =>    
            {            
                int neighbourStartIndex = maxNeighbours * b.boidId;
                ...
                {
                    /*
                    int surroundingCellCount = (int)Mathf.Ceil(bootstrap.neighbourDistance / bootstrap.cellSize);

                    // Are we looking above and below? 
                    int sliceSurrounding = bootstrap.threedcells ? surroundingCellCount : 0;
            ...
            .ScheduleParallel(partitionHandle);
                    ...
                    /*    
            var sjHandle = Entities.ForEach((ref Boid b, ref Seperation s)
            {
                Vector3 force = Vector3.zero;
                int neighbourStartIndex = maxNeighbours * b.boidId;
